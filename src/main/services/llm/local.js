...
export async function callLocalLLM(prompt, content, config) {
    try {
...
async function callOllama(prompt, content, config) {
...
async function callGenericAPI(prompt, content, config) {
